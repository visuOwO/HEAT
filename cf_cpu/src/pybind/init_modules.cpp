...
void init_cf_config(py::module_ &modules_module) {
    py::class_<cf::modules::CFConfig,
            ...
            .def(py::init<idx_t, idx_t, idx_t, idx_t, idx_t, idx_t, idx_t, idx_t, idx_t, idx_t, val_t, val_t, std::vector<idx_t> &, val_t>(),
                 py::arg("emb_dim"),
                 py::arg("num_negs"),
                 py::arg("num_users"),
                 py::arg("num_items"),
...
void init_datasets(py::module_ &modules_module) {
    ...
    py::class_<cf::modules::datasets::ClickDataset,
            ...
            .def(py::init<>([](py::array_t<idx_t, py::array::c_style> &click_dataset,
                               py::array_t<idx_t, py::array::c_style> &historical_items,
                               py::array_t<idx_t, py::array::c_style> &masks) {
                     ...
                     return cf::modules::datasets::ClickDataset(num_clicks, click_dim, clicks_vals, his_items_rows,
                                                                his_items_cols, his_items_vals, masks_rows, masks_cols,
                                                                masks_vals);
                 }),
...
void init_behavior_aggregators(py::module_ &modules_module) {
    py::module_ behavior_aggregators_module = modules_module.def_submodule("behavior_aggregators",
                                                                           "Behavior aggregators");

    py::class_<cf::modules::behavior_aggregators::AggregatorWeights,
            std::shared_ptr<cf::modules::behavior_aggregators::AggregatorWeights>>(behavior_aggregators_module,
                                                                                   "AggregatorWeights")
