...
struct CFConfig
{
    CFConfig(idx_t emb_dim, idx_t num_negs, idx_t num_users, idx_t num_items, idx_t train_size, idx_t neg_sampler, idx_t tile_size, idx_t mini_batch_size, idx_t refresh_interval, idx_t num_subepochs,
